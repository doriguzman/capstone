...
import "./Feed.css";
// class UserProfileCards extends Component{
//     constructor(props){
//         super(props);
//         this.state={
...
//     render(){
//         const {allUsers, bffs}= this.state
...
//            {!bffs ? <div><div className='destination'>Destination: {user.destination} </div>
...
const UserProfileCards = ({ allUsers, bffs }) => {
  ...
  console.log(bffs); // console.log('bye',allUsers)
  return (
    <div className="cardHolder">
      {allUsers.map(user => (
        <div className="card">
