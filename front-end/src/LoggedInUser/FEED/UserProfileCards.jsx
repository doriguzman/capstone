      ...
      {allUsers.map(user => {
        ...
        return (
          <div className="card">
            ...
            <div className="locationPC">Location: {user.my_location}</div>

            {!bffs ? (
              <div>
                {user.destination ? (
                  <div className="destinationPC">
                ...
                {user.start_date ? (
                  <div className="startDate">
                    Trip start date:{" "}
                    {dateFormat(user.start_date, "ddd, mmm, dS, yyyy")}
                  </div>
                ) : (
                  ""
                )}
                ...
                {user.end_date ? (
                  <div className="endDate">
                    {" "}
                    Trip end date:{" "}
                    {dateFormat(user.end_date, "ddd, mmm, dS, yyyy")}
                  </div>
                ) : (
                  ""
                )}
