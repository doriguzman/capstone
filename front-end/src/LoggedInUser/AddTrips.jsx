  ...
  class AddTrips extends React.Component {
    ...
    renderSurvey = e => {
      ...
      axios
        .post("/users/addTrip", {
          ...
          startDate: dateFormat(this.state.startDate._d, 'mmmm dS, yyyy'),
          endDate: dateFormat(this.state.endDate._d, 'mmmm dS, yyyy'),
    ...
    render() {
      ...
      return (
        ...
        <form>
        <br/>
         Destination: <PlacesAutocomplete classNames={addressCSSClasses} inputProps={AddressInputProps}  />
        <br/>
