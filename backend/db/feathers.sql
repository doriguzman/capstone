...
INSERT INTO users (username, password_digest, email)
 ...
 INSERT INTO attributes (user_id, first_name, age, my_location, bio, pic, ethnicity, religion, early_bird, night_owl, clubbing, spontaneous, active, sightseeing, foodie, relax, nature, extroverted, smokes, drinks)   
  VALUES (1, 'Jan', 21, 'New York, NY, USA', 'What is life without the beauty of nature?', 'https://3.bp.blogspot.com/-g2AuvgYiOLg/WScTQ8L_wDI/AAAAAAAAIaE/8d-iYFx_Law6fwTvmHxSmqqXHFzOjERywCLcB/s640/unnamed.jpg', 'White / Caucasian', 'Christian', TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE),
           (2, 'Megan', 21, 'San Diego, CA, USA', 'There is nothing like the serenity that being out in nature brings.', 'https://media.glamour.com/photos/57741970db58a48d3ac6fa5c/1:1/w_352/spl1303559_001_720.jpg', 'White / Caucasian', 'Christian', TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE),
           (3, 'Dori', 22, 'New York, NY, USA', 'Yaaaaaaas, coffeeeeee.', 'https://previews.123rf.com/images/tverdohlib/tverdohlib1706/tverdohlib170601832/80920850-woman-in-garden-pretty-girl-with-fashionable-makeup-and-red-lips-has-rose-flower-in-hair-hispanic-or.jpg', 'Latin / Hispanic', 'Christian', FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE),
           ...
           (5, 'Princess', 30, 'San Diego, CA, USA', 'Hiiii my name is Princessssss.', 'https://image1.masterfile.com/getImage/NzAwLTAwNzgxOTIyZW4uMDAwMDAwMDA=AAiv8Z/700-00781922en_Masterfile.jpg', 'Asian', 'Christian', TRUE, FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE),
           (6, 'Sergina', 30, 'Dallas, TX, USA', 'heyyyyyyyyyy im Sergina.', 'https://i.pinimg.com/736x/3c/f5/58/3cf558b97d28c6e87e0222a764a357e3--ashley-benzo-pretty-little-liars.jpg', 'Latin / Hispanic', 'Buddhist', FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE),
           (7, 'Elon', 19, 'Newark, NJ, USA', 'Hiiiii, im Elon.', 'https://i.pinimg.com/originals/21/55/16/2155161daccded2685243c2d3028ef91.jpg', 'Black / African', 'Christian', TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE),
           (8, 'Simone', 22, 'New York, NY, USA', 'Yo, eskedit.' , 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb_0gFFsEELpUaV2A4sv54cMQDZVIyc35KbdSPHvs_CkUwBFKu', 'Latin / Hispanic', 'Christian', FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE),
           (9, 'Davida', 24, 'Seattle, WA, USA', 'Coffee, yaaaaassss.', 'http://www.allygong.com/wp-content/uploads/2016/01/Ally-Gong-SF-0928.jpg', 'Asian', 'Christian', TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE),
           (10, 'Helen', 27, 'Raleigh, NC,USA', 'I like beer.', 'http://res.heraldm.com/phpwas/restmb_jhidxmake.php?idx=5&simg=201504131730143170190_20150413173942_01.jpg', 'Asian', 'Christian', TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE),
           (11, 'Selena', 26, 'Fort Lee, NJ, USA', 'What up fam, you can call me Selenaaaaa.', 'https://www.usmagazine.com/wp-content/uploads/2018/02/selena-gomez-lunch.jpg', 'Native American', 'New Age (Spiritual, but not religious)', FALSE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE),
